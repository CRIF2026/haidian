---
title: "京张·共智列车：可组合城市——从百年车钩到开放接口城市"
...
任何 AI 场景不以"上线 AI"为终点，而以五个可核验工作包为近期交付（机器可读协议见 `visual/assets/governance-protocol.json`，由 `verify-governance.js` 复核并输出审计）：

| 工作包 | 时段 | 交付物 / 验收 |
| --- | --- | --- |
| 底图与权属冻结 | 第1—20天 | 官方底图、权属与审批问题清单冻结，版本留档 |
| 连续无障碍骨架 | 第21—40天 | 无台阶路径放样、轮椅/推车通行与急停步测记录 |
| 三座可逆示范节点 | 第41—60天 | 可拆装样机就位，机械钥匙/人工台/固定导视可用 |
| 无AI基线运行 | 第61—80天 | 固定导视+纸本规则+人工排班构成可独立运行的公共服务，公开取消原因 |
| 影子模式与公共利益评审 | 第81—100天 | AI 与无AI基线并行比较，公共利益评审组作出保留/退修/撤除决定 |

**无AI基线对照（FT-03）**：每个试点与"无 AI、同人员、同场地、同开放时段"的基线并行比较；AI 只有在不降低安全、公平与可达性前提下证明净公共价值（减少等待/漏报/重复劳动），才保留到下一轮；若无净价值，保留空间改造与人工服务，撤除模型而不撤除基本通行 [data:visual/assets/governance-protocol.json]。

### 实施责任矩阵（首期项目）

21 项更新项目按协议补充"牵头主体类型/开工门槛/阶段验收/退出资产"（主体与资金均为概念建议，不构成已确定安排）：

| 项目 | 牵头类型（建议） | 成本等级 | 开工门槛 | 阶段验收 / 退出资产 |
| --- | --- | --- | --- | --- |
| P01 底图与权属冻结 | 规划—文保联合组 | L | 权利与事实审查通过 | 可追溯底图索引；争议保留经审数据 |
| P02 无障碍骨架 | 交通—公园联合组 | H | 路线审计、消防通达通过 | 全链任务通过；保留无障碍路径与标识 |
| P03 三座可逆示范节点 | 公共运营方 | M | 手工回退全部就绪 | 三项现场测试通过；失败则撤回可移动构件 |
| P04 无AI基线 | 公共运营方 | L | 固定导视/纸本/机械钥匙就绪 | 基线运行记录公开；保留人工服务 |
| P05 影子模式评审 | 独立公共利益评审组 | L | 申诉时限与公开日志就绪 | 保留/退修/撤除决定；审计账本留档 |
| P06 车钩广场开源接口场 | 政府平台公司+授权第三方 | M | 数据保护与人工复核点就绪 | 使用/投诉/无障碍KPI达标；违规即摘挂 |
| P07 信号联锁塔治理体验中心 | 政府平台公司 | M | 联锁演示与人工值守就绪 | 治理规则可读性评估；状态不符即停止 |
| P08 机器人低速配送示范线 | 园区运营商+配送企业 | M | 交通安全审计与人工接管演练通过 | 事故零容忍；路线不符即停止并人工配送 |
| P09 城市智能体应急演练场 | 治理机构+企业 | H | 应急预案与联锁演练通过 | 接管≤5分钟；超时即复盘整改 |
