...
`metrics.json` 共 **131 项指标，117 项已赋值、14 项待测**。117 项已赋值项来自 GeoJSON、合成演练、设计合同、机器校验或明确标注的参赛者预可行性与专业交接输入；其中 31 项专业实施指标只记录四级包络、开口与对角线算术、五级图纸、交付组合、文件闸门、角色、条件任务、未计价数量、交接验收，以及本轮新增的排班公式、逐包验收、具名回退、双钥匙、调试清单和未来基线结构，不把任何一项写成正式场地、法定容量、真实报价、批准预算或实施绩效。故“8/8 需求夹具”“24 场计划下限”“约 12万—29万元敏感性”“2.143 → 3 FTE”“0/2 双钥匙回执”“0/8 调试执行”“8/12 现可判交接项”和“真实观察 0”分别记录设计覆盖、未来样本计划、参赛者试算、控制结构、执行边界与包级闭合度，绝不合并为用户测试、预算通过或现场验收。14 项待测继续包括法定强度、真实交接时间、返工轮次、公众接受度、现场无障碍和运营效果，不以推测填空 [depth:metrics_recalculation]。
...
| 专业实施交接 | 5 级图纸、4 级释放、9 项目、6 包逐包验收、11 模块、12 文件闸门、12 角色；3,000 岗位小时→2.143→3 FTE、最少 4 人；双钥匙 0/2、调试 0/8、未来基线 5 时段×7 表；12 条件任务、16 行未计价数量、12 项验收 | 交付接口可复核；闸门回执、具名任命、正式单价、调试执行、现场观察、施工及开放放行均为 0 |
