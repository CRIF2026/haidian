...
AI建议只有在具名专业角色核实资料并作出决定后，才可以改变空间或实施安排。连续通行、无障碍、基础公共服务、人工与非数字路径、拒绝参与和异常恢复是所有场景共同的公共保障条件；任一条件不能满足，智能环节停止，日常服务继续。

### 三处AI辅助空间判断与退出安排

| 场地 | 核查对象 | AI辅助 | 人工决定 | 空间动作 | 停止与恢复 |
| --- | --- | --- | --- | --- | --- |
| 众智园 | 普通共享功能是否需要新增专用空间 | 并列整理载体与需求，识别可共享、可改造、确需专用和证据缺失事项。 | 规划、建筑、市政和运营人员核实条件，决定共享、改造或是否保留专用新建。 | 普通功能分布到多个载体；新增体量只承担经核实且不可替代的专用条件。 | 资料不完整或不可替代性未证明时，不启动普通共享功能的新建，现有共享与人工服务继续运行。 |
| AI原点 | 拆并更新是否会损害细密街院联系 | 把拆并与保留修补方案按空间后果并列整理，提示缺失证据和受影响联系。 | 规划、建筑、消防、权属和运营主体核实逐栋条件，决定保留修补或局部重构。 | 在修补不可行尚未被证明前，不减少独立入口、短街、院落联系和小型使用单元。 | 关键资料缺失、无障碍变差或公共通行被封闭时，暂停拆并方案，返回保留修补核查并保持原有通行。 |
| 大钟寺 | 多个项目如何共同形成并兑现公共基面 | 归并需求，识别同时发生、相互冲突、可错峰和被重复认领的公共改善。 | 交通、市政、公共空间、项目管理和运营主体共同确定规模、断面、时序与责任。 | 公共改善单独编号，形成独立工程包、责任分配和验收记录，不由经营项目开业替代。 | 连续通行、无障碍、责任或独立验收条件未落实时，相关公共改善不得被经营项目提前认领，基础路径与服务保持开放。 |

### 公众使用与公共服务保障条件

- **PG-01 · 基础服务不被挤占**：基本通行、公共服务与无消费休息不被展示、测试、配送或经营活动挤占。
- **PG-02 · 实体无障碍优先**：连续无障碍物理路线优先，智能解释不能替代障碍修复和安全核查。
- **PG-03 · 保留人工与非数字路径**：基础信息、求助和服务保留人工、纸面或固定标识，不依赖手机或账户。
- **PG-04 · 拒绝参与不降级**：公众可以拒绝参加测试；拒绝、投诉或不用AI不得降低基础服务。
- **PG-05 · 异常后恢复日常使用**：异常时停止智能环节，撤除可逆设施并记录恢复日常使用的状态。
...
| 场地 | 首轮核查任务 | 未通过时的处理 |
| --- | --- | --- |
| 众智园 | 完成一份跨载体容量—专用需求对照；不能证明不可替代时，以共享或改造方案结束核查。 | 资料不完整或不可替代性未证明时，不启动普通共享功能的新建，现有共享与人工服务继续运行。 |
| AI原点 | 选择一组入口—短街—院落联系，完成拆并与保留修补的并列核查；未通过时不减少现有联系。 | 关键资料缺失、无障碍变差或公共通行被封闭时，暂停拆并方案，返回保留修补核查并保持原有通行。 |
| 大钟寺 | 选择一项跨项目公共改善，登记唯一编号、服务范围、责任和独立验收；责任未清时不得重复计入项目承诺。 | 连续通行、无障碍、责任或独立验收条件未落实时，相关公共改善不得被经营项目提前认领，基础路径与服务保持开放。 |
