---
title: "NO GENERIC SOLUTION FOR JING-ZHANG — Three Site-Specific Spatial Rules for the AI Era"
...
summary: "Three verifiable spatial rules turn repetitive generated proposals into three distinct renewal choices for Zhongzhiyuan, AI Origin and Dazhongsi."
...
![Overall spatial relationship diagram](assets/figures/site-overview.en.png)
...
![Land-use and spatial structure diagram](assets/figures/land-use-structure.en.png)
...
![Key-area spatial relationship diagram](assets/figures/key-areas.en.png)
...
![Mobility and blue-green public-space diagram](assets/figures/mobility-bluegreen.en.png)
...
![Metrics and implementation evidence diagram](assets/figures/metrics-evidence.en.png)
