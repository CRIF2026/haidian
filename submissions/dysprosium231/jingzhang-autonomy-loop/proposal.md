...
仅有“与区域协同”这句话不足以说明一带如何工作。本节把北纬社区、未来科学城、怀柔科学城、经开区和京津冀写成五个可讨论的接口：每个接口都同时列出建议角色、进入京张带的要素、从京张带返回的公共或产业回流，以及需要核实的边界 [source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK]。

| 区域接口 | 建议角色（非既有合作声明） | 进入京张带的双向要素 | 京张带接口 | 当前不确定性与核验动作 |
| --- | --- | --- | --- | --- |
| 北纬社区 | 北部日常生活与公共服务接口 | 进入：居民日常需求、使用反馈、社区议题；返回：可旁观的 AI 服务原型、文化路线与人工服务经验 | 北五环接驳段、学习脊北端、社区服务节点 | 社区边界、人口结构和需求基线未取得；需开展现场走访与服务清单核验 |
| 未来科学城 | 上游研发、企业孵化与技术供给接口 | 进入：研发议题、算力与人才线索；返回：城市场景需求、公共测试反馈与可解释展示 | 众智园研发端、模型评测开放日、标准治理工作坊 | 机构关系、数据与算力可共享范围未确认；需以公开规划和主体授权核验 |
| 怀柔科学城 | 长周期基础研究与科学议题接口 | 进入：基础研究问题、长期评测方法与科学传播内容；返回：城市尺度验证问题、公众可理解的研究叙事 | 自主之环、遗产叙事导览、年度回路周 | 具体研究协作和成果转化路径未知；不得写成现有合作，需由专业主体确认 |
| 经开区 | 产业化、机器人与规模化应用接口 | 进入：产业测试需求、制造与低速机器人应用线索；返回：公共空间试验反馈、人才与场景展示 | 小月河场景赋能翼、低速配送试验段、活动日沙盘 | 产业主体、交通条件和安全责任未确认；需完成场景准入与工程安全评估 |
| 京津冀 | 跨区域人才、资本、案例与传播网络接口 | 进入：跨区域人才流、资本与案例交换；返回：可复用的开放场景规则、公共利益评估方法与文化传播内容 | 国际路演客厅、开发者社区、开放成果展示 | 跨区域交通、资金和组织机制未确认；需用公开政策与主体意愿逐项核验 |

这张接口表的含义是提出可验证的协同假设，而不是声称已经存在合作、资金、数据共享或政府安排。近期可先验证“问题—场景—反馈”三类轻量接口；涉及算力、交通、机器人、跨区域数据或主体合作的内容，均须在授权、专业评估和责任边界明确后再推进 [depth:overall_spatial_structure]。

![五个区域接口与京张自主回路](assets/figures/regional-coordination.png)
