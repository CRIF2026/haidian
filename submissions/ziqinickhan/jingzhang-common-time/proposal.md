---
title: "京张共时 / Jing-Zhang Common Time"
author_github: "ziqinickhan"
language: "zh"
proposal_format_version: "2"
bilingual_contract_version: "1"
translation_file: "proposal.en.md"
license: "COMMUNITY-DISPLAY-ONLY"
summary: "以公共可达性与共同时间为基础设施的概念性城市设计：AI 服务只在清晰、可选择、可暂停并保留非 AI 等价路径的时段和场所出现。"
...
# 京张共时 / Jing-Zhang Common Time

> 核心判断：AI 创新带首先应回答“谁能在何时使用城市公共空间，以及技术关闭后普通生活是否仍完整”。本方案以共同时间和公共可达性作为基础设施；一切 AI 服务均为可选择、有限时、可人工复核、可暂停且保留线下等价路径的概念建议。
...
本方案将“共同时间”落入可审查的场景合同，而非抽象技术口号。六项场景—空间—运营矩阵为本节组成部分：每项均列出空间位置类型、候选运营主体、最小数据、人工复核、线下等价、暂停条件与评价指标；其中慢行断点诊断、公共修理台账和开源评测公开日仅作为概念性受监督试验，不接入未经授权的个人数据，不控制交通，也不替代公共服务决定。

方案比较 Barcelona、Helsinki、Amsterdam、Seoul、Toronto 与 Singapore 的公开治理经验及其不可照搬边界。比较结论不是将其他城市制度移植到海淀，而是确认一项公共数字服务进入场地前至少应说明：公共目的、空间载体、责任主体、最小数据、非数字替代、投诉与退出。上述服务、合作主体与频率均为建议/候选，须经后续授权和专业深化确认。

### 任务书的实质响应与区域协作

“三区两翼”不是标题并列：众智园承接全栈研发与安全治理，AI 原点承接人才、开源与成果转化，大钟寺承接城市展示、交流与智能原生消费；中关村科技服务翼提供专业服务与要素配置，小月河场景赋能翼把低门槛公共体验接回日常慢行网络。三大定位和五大功能的空间载体、产业机制、场景、运营接口、证据与待确认条件逐项列在任务覆盖矩阵；此处提出的北纬社区、未来科学城、怀柔科学城、经开区和京津冀连接，仅是研发、验证、人才、终端、活动或问题清单的**合作建议**，须由对应主体确认，不构成既定关系 [source:AGENT-TASKBOOK] [data:geometry/key_areas.geojson#PROV-KEY-001]。

### 品牌、文化与公共空间组件

“京张共时 / Jing-Zhang Common Time”的标识方向是一条穿过三枚节点的时间脊线：深蓝代表可信公共底板，薄荷绿代表慢行生态，赭红代表文化记忆，金色代表公共时刻。它有中英标准字、单色版、最小尺寸、留白和禁用规则，且明确区别于文化导视与活动子品牌。文化叙事以“铁路连接的时间—中关村问题解决的时间—AI 服务回到人的时间”组织，导视分为方向、解释、参与三层；不将未经核实的历史、商标、肖像或机构关系写成事实。共时里程标、开源回声厅、交换云台三类概念地标及可移动座椅、遮荫、无障碍信息柱、双层导视等组件，均设安全、维护与暂停边界，待专业团队核验 [source:AGENT-TASKBOOK] [depth:public_space_character]。

### 全球参照、生态图谱与三项验证合同

Barcelona、Helsinki、Amsterdam、Toronto、Singapore、Seoul 与 London 的可审查案例用于比较数字权利、算法登记、公共监督、开放创新、包容治理和双语告知的方法，而非复制其制度或宣称合作。土地/空间、产业、资源、人才、算力、数据和场景的八类要素被映射到三处重点区与两翼；完整案例表、来源、适用边界见 `report/narrative.md`。慢行断点诊断、安全治理沙盒、公共服务问答辅助三项测试合同，逐一说明位置类型、输入/输出、最小数据、模型局限、人工复核、投诉退出、暂停阈值、候选责任与量化评价；完整矩阵见 `report/narrative.md`。在未完成场地许可、数据保护、无障碍与安全审查前，它们绝不进入真实运营 [source:AGENT-TASKBOOK] [data:geometry/roads.geojson#ROAD-001]。

### 年度运营与实施升级

JZ-01 至 JZ-06 的深化应采用“候选牵头/协作—阶段门—依赖—交付物—资源级别—KPI—投诉退出—转化路径”的共同模板。建议以春季问题走读、夏季开发者安全沙盒、秋季场景开放日、冬季国际对话与归档组织年度循环：每个阶段先许可和复核、再限量验证、再公开复盘，未授权数据、安全事件或未闭环投诉均可触发暂停。活动、社区、场景开放、公共体验和国际传播均为概念运营框架；详细交付、成本级别和验收指标见 `report/narrative.md`，不构成投资、招商或政府承诺 [depth:renewal_project_list] [source:AGENT-TASKBOOK]。
